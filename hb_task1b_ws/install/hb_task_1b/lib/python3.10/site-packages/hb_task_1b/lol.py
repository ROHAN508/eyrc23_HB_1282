...
class HBTask1BController(Node):
    ...
    def odometryCb(self,msg):
        global hb_x, hb_y, hb_theta,hb_z
        current_pos= msg.pose.pose.position
        if hb_x == None and hb_y == None and hb_theta == None:
            (hb_x, hb_y, hb_z) = (current_pos.x, current_pos.y, current_pos.z)
        self.present_x=current_pos.x
        self.present_y=current_pos.y
        inc_x = self.goal.x - self.present_x
        inc_y = self.goal.y - self.present_y
