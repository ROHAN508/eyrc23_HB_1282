...
class HBControl(Node):
    ...
    def __init__(self):
        ...
        self.subscription_bot = self.create_subscription(Goal,'hb_bot_2/goal', self.goalCallBack1, 10) 
        self.startrun = self.create_subscription(Bool,"/startrun", self.startCallBack1, 10)

        

        self.sub_bot = self.create_subscription(Pose2D, "/pen2_pose", self.Callback1, 10)
        self.twist_1 =  Float64MultiArray()
        
        self.stop_pub_1 = self.create_publisher(Bool, "/stop_bot2", 10)
        self.stop_bot = Bool()
        ...
        self.pub_1 = self.create_publisher(Float64MultiArray, '/map2', 10)
        self.pen_pub1 = self.create_publisher(Bool, '/pen2_down', 10)
        self.pen1=Bool()
...
class HBControlimg(Node):
    ...
    def __init__(self):
        ...
        self.subscription_bot3 = self.create_subscription(Goal,'hb_bot_2/goal_img', self.goalCallBack1, 10) 
