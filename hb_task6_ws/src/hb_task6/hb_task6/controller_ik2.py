...
class HBControl(Node):
    def __init__(self):
        ...
        self.stopCollision = self.create_subscription(Bool,"/pen2_stop", self.stopcallback, 10)

        self.stopCollisiontc = self.create_subscription(Bool,"/pen2_stoptc", self.stopcallbacktc, 10)
