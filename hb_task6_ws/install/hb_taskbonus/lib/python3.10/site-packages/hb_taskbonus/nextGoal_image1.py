...
fullimage2=[returncontour(6),returncontour(12),returncontour(23),returncontour(21),returncontour(14),returncontour(19)]
...
class ServiceNode(Node):
    ...
    def __init__(self):
        ...
        self.run_complete2 = self.create_publisher(Bool, '/pen1_complete', 10)

        self.bot2_complete=Bool()
        self.bot2_complete.data=False

        self.pen_2_status = self.create_subscription(Bool, "/pen1_down", self.checkPenStatus_2, 10)
